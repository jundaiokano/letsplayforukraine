...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'story.eishin.bio': 'Born in Hiroshima in 2007 of Ukrainian-Japanese heritage. After studying at the Hanover University of Music, Drama, and Media (VIFF) in Germany, he is currently pursuing his musical studies at Ball State University in the United States. In the summer of 2025, he joined Carnegie Hall\'s National Youth Orchestra of the USA (NYO-USA) as principal violist for its Asia tour. His accolades include the Tokiko Iwatani Foundation Award and top prizes at the international "Flame" competition in Paris.',
  ...
  ja: {
    ...
    'story.eishin.bio': '2007年広島生まれ、ウクライナにルーツを持つ。ドイツ・ハノーファー音楽演劇大学の英才教育機関（VIFF）を経て、現在は米ボール州立大学にてヴァイオリン、ヴィオラ、指揮法などを学んでいる。 2025年夏、カーネギーホール・米国立ユースオーケストラ（NYO-USA）のアジアツアーにヴィオラ首席として参加。パリ「Flame」国際コンクールでの優勝（ピアノ）および第2位（ヴァイオリン）ほか、岩谷時子財団 Foundation for Youth 賞など受賞歴多数。',
